package com.ytl.rxandroiddemo.fragment;
...
import com.ytl.rxandroiddemo.R;
...
public class BlankFragment extends Fragment
{
    ...
    private void receive()
    {
       ...
       RxBus.getInstance().toObservable(Object.class).subscribe(mySubscriber);*/
